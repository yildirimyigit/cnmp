...
data_path = "data/sfm/small_env_changing_s_g/generate_trajectory/demonstrations/"
# "data/sfm/continuous_poses_timed_trajectories/demonstrations/"
novel_data_path = "data/sfm/continuous_poses_timed_trajectories/demonstrations/"

output_root_path = "output/sfm/small_env_changing_s_g/generate_trajectory/"
# f'output/sfm/continuous_poses_timed_trajectories/'
...
X, Y, gamma = (np.load(data_path + 'd_t.npy'), np.load(data_path + 'd_x.npy'), np.load(data_path + 'd_m.npy'))
v_X, v_Y, v_gamma = (np.load(data_path + 'v_d_t.npy'), np.load(data_path + 'v_d_x.npy'),
                     np.load(data_path + 'v_d_m.npy'))

(X, Y, gamma) = sample((X, Y, gamma), num=7000)
(v_X, v_Y, v_gamma) = sample((v_X, v_Y, v_gamma), num=400)
...
novel_X, novel_Y, novel_gamma = (np.load(novel_data_path + 'd_t.npy'), np.load(novel_data_path + 'd_x.npy'),
                                 np.load(novel_data_path + 'd_m.npy'))
        ...
        if self.step % self.plot_checkpoint == 0:
            ...
            for i in range(v_X.shape[0]):
                ...
                predict_model(np.concatenate((v_X[i, 0], v_Y[i, 0])).
                              reshape(1, 1, d_x+d_y), v_X[i].reshape(1, time_len, d_x), plot=False)
