...
X, Y, gamma = (np.load(data_path + 'd_t.npy'), np.load(data_path + 'd_y.npy'), np.load(data_path + 'd_gamma.npy'))
v_X, v_Y, v_gamma = (np.load(data_path + 'v_d_t.npy'), np.load(data_path + 'v_d_y.npy'),
                     np.load(data_path + 'v_d_gamma.npy'))

(X, Y, gamma) = sample((X, Y, gamma), num=1600)
...
novel_X, novel_Y, novel_gamma = (np.load(novel_data_path + 'd_t.npy'), np.load(novel_data_path + 'd_y.npy'),
